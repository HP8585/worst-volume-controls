<template>
    <div class="flex flex-col justify-center items-center">
        ...
        <div class="relative w-[500px] h-[500px]">
            <div
                ref="wheel"
                class="w-full h-full mb-10 relative overflow-hidden rounded-full border-[10px] border-white duration-1000 transition-all ease-6s"
            >
                <div>
                    <span
            ...
            <div
                class="absolute mt-1 w-0 h-0 border-l-[25px] border-l-transparent border-r-[25px] border-r-transparent border-t-[50px] border-white top-0 left-[45%]"
            ></div>
            <button
